...
Dpivot <- function(Array)
{
  padding = 5 - length(Array)%%5
  Array_new =  c(Array, rep(Inf, padding))
  Splits = matrix(Array_new, 5)
  Splits = apply(Splits, 2, sort )
  
  mid = ceiling(ncol(Splits)/2)
